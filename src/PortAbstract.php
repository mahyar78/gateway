...
abstract class PortAbstract {
    ...
    /**
     * Get port config names (ex: terminalId, merchantId , ...) stored in database
     * @return array[]
     */
    protected abstract function getConfigNames();

    /**
     * Get port data from database and set to configs
     * @return void
     */
